...
<body>
    <div class="container-fluid main-container d-flex align-items-center justify-content-center"
        style="min-height: 100vh; background-image: url('imagemSigno.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        ...
        <div class="content-wrapper text-center p-5"
            ...
            <footer class="footer mt-5">
                <p class="text-muted">Desenvolvido por: Thiago</p>
            </footer>
        </div>
    </div>
</body>